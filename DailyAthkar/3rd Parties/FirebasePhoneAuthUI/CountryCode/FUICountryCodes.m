...
- (void)localizeCountryCodesArray {
  ...
  for (NSDictionary *dict in self.countryCodesArray) {
    ...
    NSString *localizedCountryName = [FUICountryCodes localizedCountryNameForCountryCode:dict[kFUIJSONCountryCodeKey]];
...
+ (NSString *)localizedCountryNameForCountryCode:(NSString *)countryCode {
    NSLocale *locale = [[NSLocale alloc] initWithLocaleIdentifier: [LanguageManager currentLanguageCode]]; //[NSLocale currentLocale];
